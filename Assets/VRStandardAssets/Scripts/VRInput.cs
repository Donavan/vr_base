...
namespace VRStandardAssets.Utils
{
    ...
    public class VRInput : MonoBehaviour
    {
        ...
        public VRTK_ControllerEvents[] _controllers;
        private void Update()
        {
            CheckInput();
        }
        ...
        private bool FireDown()
        {
            ...
            {
                // TODO: need alloc free iter
                foreach (var controllerEvent in _controllers)
                {
                    if (controllerEvent.triggerPressed || controllerEvent.triggerClicked)
                        trigger_down = true;
                }
            ...
            Debug.LogWarning(trigger_down);
            return Input.GetButtonDown("Fire1") || trigger_down;
        }
        ...
        private bool FireUp()
        {
            ...
            return Input.GetButtonUp("Fire1") || trigger_up;
        }
